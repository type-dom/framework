...
// //   normalizeStyle,
// // } from '@vue/shared'
import { isArray, isOn, normalizeClass, normalizeStyle } from '@type-dom/utils';
// import {
//   // type ClassComponent,
//   // type Component,
...
// export const blockStack: TypeNode[] = []
// export let currentBlock: TypeNode | null = null
//
// /**
//  * Open a block.
...
export function mergeProps(...args: (Data & TypeProps)[]): Data {
  const ret: Data = {}
