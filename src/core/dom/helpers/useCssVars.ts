...
// import { warn } from 'src/utils/debug';
// import { NOOP, ShapeFlags } from '../../../shared'
// import { getCurrentInstance } from '../../instance';
// import { onBeforeUpdate, onMounted, onUnmounted } from '../../apiLifecycle';
// import { queuePostFlushCb } from 'src/core/scheduler';
...
export function setVarsOnNode(el: Node, vars: Record<string, string>) {
  if (el.nodeType === 1) {
