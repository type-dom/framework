...
import type { AppContext } from '../dom/components/app/app.interface';
// import {
//   type Suspense,
...
import { type TransitionHooks, // setTransitionHooks,
} from './abstracts/type-transition/type-transition.interface';
...
type VNodeMountHook = (node: VNode) => void
type VNodeUpdateHook = (node: VNode, oldVNode: VNode) => void
...
export function mergeProps(...args: TypeProps[]): Data {
  const ret: Data = {}
  for (let i = 0; i < args.length; i++) {
    const toMerge = args[i] as any;
