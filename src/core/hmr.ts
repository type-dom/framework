...
//     instances: Set<TypeElement>
//   }
// > = new Map()
//
// export function registerHMR(instance: TypeElement): void {
//   const id = instance.__hmrId!
//   let record = map.get(id)
//   if (!record) {
//     createRecord(id, instance as HMRComponent)
//     record = map.get(id)!
//   }
//   record.instances.add(instance)
// }
//
// export function unregisterHMR(instance: TypeElement): void {
