...
type SetRootFn = ((root: TypeNode) => void) | undefined
 ...
 */
const getChildRoot = (vnode: TypeNode): [TypeNode, SetRootFn] => {
  ...
  const setRoot: SetRootFn = (updatedRoot: TypeNode) => {
...
//   const emits = prevVNode!.emitsOptions
//
...
//       return hasPropsChanged(prevProps as Data, nextProps! as Data, emits)
//     } else if (patchFlag! & PatchFlags.PROPS) {
//       const dynamicProps = nextVNode.dynamicProps!;
//       for (let i = 0; i < dynamicProps.length; i++) {
//         const key = dynamicProps[i];
//         if (
//           (nextProps! as Data)[key] !== (prevProps! as Data)[key] &&
...
//   prevProps: Data,
//   nextProps: Data,
//   emitsOptions: any, // ComponentInternalInstance['emitsOptions'],
// ): boolean {
