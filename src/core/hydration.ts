...
export type RootHydrateFunction = (
  vnode: TypeNode, // VNode<Node, Element>,
...
// export const isMathMLContainer = (container: Element) =>
...
//     const children = parentVNode.children as TypeNode[]
...
// export function isMapEqual(a: Map<string, string>, b: Map<string, string>): boolean {
//   if (a.size !== b.size) {
//     return false
//   }
