...
export interface TypeProps extends ITypeBase {
  ...
  config?: any; // 全局配置属性；
  key?: string | number;
  tag?: MaybeRef<keyof HTMLElementTagNameMap | 'fragment' | NodeName.COMMENT | NodeName.TEXT | string>; // 转为 tag
   ...
   * 与anchor无关
   */
  refDom?: Ref<Element | DocumentFragment | null | undefined>;
   ...
   */
  attrObj?: MaybeRef<Attributes | undefined>;
  /**
   * 样式对象。
   */
  styleObj?: StyleValue;
  ...
  beforeRouteEnter?(...args: any[]): any;
  beforeRouteLeave?(...args: any[]): any;
  beforeRouteUpdate?(...args: any[]): any;
...
export type IChild = string | number | boolean | symbol | null | undefined | Dayjs | TypeNode | Ref<string | number | boolean | Dayjs | undefined>;
...
export type ISlotItem<T extends IChild = IChild> = T | T[]
  | ((...args: any[]) => ISlotItem<T> | void);

export interface ISlots {
  [propName: 'default' | string]: ISlotItem | void | undefined;
}
