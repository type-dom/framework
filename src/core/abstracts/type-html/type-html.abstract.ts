 ...
 * 将组件和dom的具体类型进行了关联；
 */
import { HTMLAttributes, addAttrObj, setAttrObj } from '../../../dom/modules/attribute';
...
export abstract class TypeHtml<
  ...
  > extends TypeElement<Props, Attrs> implements ITypeHtml {
  /**
   * 代表HTML元素的抽象属性。
  ...
  override addAttrObj(attrObj?: Attrs) {
    addAttrObj(this, attrObj);
  }

  override setAttrObj(attrs?: Attrs) {
    setAttrObj(this,  attrs)
  }

  override addStyleObj(styleObj?: StyleValue) {
    addStyleObj(this, styleObj);
  }

  override setStyleObj(styleObj?: StyleValue) {
