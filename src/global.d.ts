...
import type { Logger } from '@type-dom/utils';
...
declare global {
  ...
  let __COMPAT__: boolean;
  let __FEATURE_PROD_DEVTOOLS__: boolean;
  let __FEATURE_PROD_HYDRATION_MISMATCH_DETAILS__: boolean;
  let __FEATURE_OPTIONS_API__: boolean;
}
