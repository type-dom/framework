...
import {
  ...
  setTransitionHooks,
  useTransitionState,
} from '../../../core/abstracts/type-transition/type-transition.use';
import {
  addTransitionClass,
  forceReflow,
...
import type { ElementWithTransition } from '../transition/transition.interface';
import {
  applyTranslation,
  callPendingCbs,
  hasCSSTransform,
...
import type { TransitionGroupProps } from './transition-group.interface';
...
export class TransitionGroup<Props extends TransitionGroupProps> extends TypeHtml<Props> {
  ...
  constructor(params: Props = {} as Props) {
    ...
    this.dom = document.createElement(unref(params.tag) ?? params.nodeName ?? 'div');
  }
