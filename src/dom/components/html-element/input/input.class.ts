import { TypeInput } from '../../../../core/abstracts/type-html/input/input.abstract';
import { InputProps } from '../../../../core/abstracts/type-html/input/input.interface';
...
export class Input extends TypeInput implements IInput {
   ...
   */
  get type(): string {
    return (this.attrObj as InputHTMLAttributes)?.type as string;
  }
