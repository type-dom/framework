import { TypeMenuItem } from '../../../../core/abstracts/type-html/menu-item/menu-item.abstract';
import { MenuItemProps } from '../../../../core/abstracts/type-html/menu-item/menu-item.interface';
