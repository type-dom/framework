...
import { patchStyle } from './modules/style/patchStyle'
import { patchAttr } from './modules/attribute/attrs'
...
export const patchProp = (
  ...
  if (key === 'class') {
    ...
    if (!isModelListener(key)) {
      patchEvent(el, key as `on${string}`, prevValue, nextValue, parentComponent);
    }
  } else if (
    key[0] === '.'
