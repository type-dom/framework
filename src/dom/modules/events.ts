import { AnyFn, hyphenate, isArray } from '@type-dom/utils'
...
export function patchEvent(
  ...
  instance: TypeNode | undefined  = undefined,
): void {
  // vei = v event invokers
  const invokers = el?.[veiKey] || (el[veiKey] = {})
  const existingInvoker = invokers[rawName]
  if (nextValue && existingInvoker) {
    // patch
    existingInvoker.value =(nextValue as EventValue); // __DEV__
