...
import { ITransitionConfig } from '../events/events.interface';
...
export function transition(element: TypeElement, config: ITransitionConfig) {
//  todo
}
...
export interface RendererElement extends RendererNode {
  style?: string; // no meaningful value
}
...
function normalizeDuration(
  ...
  if (duration == null) {
    ...
    return [NumberOf((duration as any).enter), NumberOf((duration as any).leave)];
  } else {
