...
describe('toDisplayString', () => {
  ...
  test('primitive values in refs', () => {
    expect(toDisplayString(signal(0))).toBe('0')
    expect(toDisplayString(signal(1))).toBe('1')
    expect(toDisplayString(signal(NaN))).toBe('NaN')
    expect(toDisplayString(signal(true))).toBe('true')
    expect(toDisplayString(signal(false))).toBe('false')
    expect(toDisplayString(signal('hello'))).toBe('hello')
  })

  test('symbol values', () => {
    expect(toDisplayString(Symbol('hello'))).toBe('Symbol(hello)')
    expect(toDisplayString(signal(Symbol('hello')))).toBe('Symbol(hello)')
  })
