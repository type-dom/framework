...
import { TypeFragment, render, useAttrs, useSlots } from '../../src';
import { mergeDefaults } from '../../src/core/apiSetupHelpers';
import { SetupContext } from '../../src/core/component';

describe('SFC setup helpers', () => {
  ...
  test('useSlots / useAttrs (no args)', () => {
    ...
    render(new Comp({ attrObj: passedAttrs, slots: passedSlots }), document.createElement('div'));
