...
describe('api: provide/inject', () => {
  it('string keys', () => {
    ...
    // new Provider().mount(root);
    const root = new Div({
      slot: new Provider(),
    });
    root.mount(document.body);
    // expect(serialize(root)).toBe(`<div>1</div>`)
    expect(serialize(root)).toBe(`<div><fragment><fragment><fragment>1</fragment></fragment></fragment></div>`)
  })
  ...
  it('symbol keys', () => {
    ...
    expect(serialize(root)).toBe(`<div><fragment><fragment><fragment>2</fragment></fragment></fragment></div>`)
  })
  ...
  it('default values', () => {
    ...
    expect(serialize(root)).toBe(`<div><fragment><fragment><fragment>foobar</fragment></fragment></fragment></div>`)
  })
  //
